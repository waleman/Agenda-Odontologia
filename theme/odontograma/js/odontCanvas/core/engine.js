...
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/util/constants.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/util/settings.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/models/rect.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/models/damage.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/models/textBox.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/models/tooth.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/core/renderer.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/core/odontogramaGenerator.js'></script>");
document.writeln("<script type='text/javascript' src='../theme/odontograma/js/odontCanvas/core/collisionHandler.js'></script>");
